...
@Component
@StepScope
public class PortfolioStatisticsRIPWriter extends JdbcBatchItemWriter<PortfolioStatisticsRIPVO> {

  public PortfolioStatisticsRIPWriter(DataSource dataSource,
      @Value("#{jobParameters['executionId']}") Long executionId,
      @Value("#{jobParameters['model']}") String model) {
    setDataSource(dataSource);
    setSql("INSERT INTO portfolioStatisticsRIP (executionId, model, eventId, deterministicLoss,"
