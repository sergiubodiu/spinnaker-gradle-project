...
import cloud.sgrc.terraform.jobs.JobStatus
...
class TerraformPollerSpec extends Specification implements TestDefaults {
  ...
  void 'scheduled update queries job executor and stores status and logs when incomplete'() {
    setup:
      ...
      def incompleteBakeStatus = new JobStatus(id: JOB_ID,
                                                resource_id: JOB_ID,
                                                state: bakeState,
                                                result: bakeResult,
